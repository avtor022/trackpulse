...
func (a *App) createMonitoringTab() fyne.CanvasObject {
	a.monitoringPanel = NewMonitoringPanel(a.competitionService, a.participantService, a.lapService, a.competitorModelService, a.competitorService, a.modelService, a.mainWindow)
